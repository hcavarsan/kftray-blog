---
title: Debug HTTP Traffic in kubectl port-forward
description: How to capture and inspect HTTP request and response logs from kubectl port-forward sessions using KFtray v0.11.7.
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/httptraffic1.mp4" type="video/mp4" />
</video>
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/httptraffic2.mp4" type="video/mp4" />
</video>
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/httptraffic3.mp4" type="video/mp4" />
</video>
