...
description: KFTray v0.10.0 adds support for multiple kubeconfig files, making it easier to manage port-forward configurations across clusters.
image: /img/cover.png
date: 2024-05-07
...
[Kubernetes Debugging - How to Handle Multiple kubectl port-forward from Your Tray](/blog/kubernetes-debugging-handling)
...
<YouTubeEmbed videoId="H6UJCfUr8yE" />
