---
title: Auto-Import kubectl port-forward from Annotations
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/auto-import.mp4" type="video/mp4" />
</video>
...
![Kftray Banner](https://raw.githubusercontent.com/hcavarsan/kftray-k8s-tf-example/refs/heads/main/docs/kftray.gif)
...
![kftui](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/pj66296vgfaalg960mkk.gif)
