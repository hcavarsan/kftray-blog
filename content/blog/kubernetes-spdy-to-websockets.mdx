---
title: Kubernetes SPDY to WebSockets Migration Explained
description: How Kubernetes is replacing SPDY with WebSockets for kubectl exec, attach, cp, and port-forward — the protocol changes, timeline, and what it means for tooling.
