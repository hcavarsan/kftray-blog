---
title: kftui — Simpler kubectl Port-Forward Management
description: A practical guide to kftui — the terminal interface for managing kubectl port-forwards with keyboard navigation, CLI scripting, and SSH compatibility.
...
![Complete Diagram](/img/kftui2025.png)
...
![Auto-Discovery](/img/kftuiauto.png)
...
![Settings](/img/kftuisettings.png)
...
![HTTP Logs](/img/kftuihttplogsview.png)
...
#### **HTTP Detail Mode** :
![HTTP Logs](/img/kftuilogsdetails.png)
...
![HTTP Logs](/img/httplogsdetails.png)
