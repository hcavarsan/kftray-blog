---
title: Multiple kubectl port-forward from Your Tray
description: KFTray centralizes multiple kubectl port-forward sessions in a system tray app for faster Kubernetes debugging.
image: /img/kubernetes-debugging-cover.png
date: 2024-04-21
...
<YouTubeEmbed videoId="nqEhmcKeCc4" />
...
<YouTubeEmbed videoId="BAdL7IzaEh8" />
