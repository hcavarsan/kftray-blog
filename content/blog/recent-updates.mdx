---
title: GitHub Sync and New Frontend in kftray
description: Recent kftray updates covering improved GitHub sync for team config sharing and a fully refactored React frontend.
image: /img/github-post.webp
date: 2024-11-22
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/github.mp4" type="video/mp4" />
</video>
