---
title: Manage All Kubernetes Port-Forwards with kftray
description: How kftray manages Kubernetes TCP and UDP port-forwards with GUI and TUI, proxy forwarding, and GitHub config sync.
image: /img/cover6.webp
date: 2025-04-17
...
[kftui blog post](/blog/kftui-port-forward)
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/adding-config.mp4" type="video/mp4" />
</video>
...
[auto import blog post](/blog/kubectl-port-forward-auto-import)

<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/auto-import-gui.mp4" type="video/mp4" />
</video>
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/export-import.mp4" type="video/mp4" />
</video>
...
<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/git-sync.mp4" type="video/mp4" />
</video>
...
[http logging blog post](/blog/kftray-http-logs-vscode)

<video autoPlay loop muted playsInline className="my-6 w-full rounded-xl border border-fd-border">
  <source src="/img/http-logs-vscode.mp4" type="video/mp4" />
</video>
