...
All three interfaces (desktop, terminal, MCP) share the same SQLite database at `~/.kftray/kftray.db`. This means:
...
| **kftray-mcp** | [MCP server](/docs/interfaces/mcp), exposes port-forwarding operations over HTTP |
