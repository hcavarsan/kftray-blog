...
# Discover annotated services and start forwards headlessly
...
| `--context` | Kubernetes context to use for auto-discovery |
| `--kubeconfig` | Path to kubeconfig file for auto-discovery (default: system default) |
