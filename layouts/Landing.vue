...
<template>
	<div class="page-layout">
	  <div class="relative overflow-hidden">
		<LandingBanner badge-text="Release v0.15.1" text="A new version of kftray has been released."
		  link="https://github.com/hcavarsan/kftray/releases/tag/v0.15.1" link-text="Check it out →" />
